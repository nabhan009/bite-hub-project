...
// import HeroScroll from "../stepScrolling";
...
//              <button className="group px-10 py-4 bg-orange-600 rounded-full font-black text-[10px] uppercase tracking-widest hover:bg-white hover:text-orange-600 transition-all duration-500">
//                Live Feed
//              </button>
//           </div>
//         </div>
