...
useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white p-6 pt-32 pb-20 selection:bg-orange-500/30">
      <div className="max-w-7xl mx-auto">
        ...
        <section className="bg-[#0d0d0d] border border-white/5 p-8 rounded-[2.5rem] mb-16 shadow-2xl relative overflow-hidden group">
    ...
    <div className="meal-card group bg-[#0d0d0d] border border-white/5 rounded-[2.5rem] overflow-hidden hover:border-orange-500/30 transition-all duration-500 shadow-xl relative">
      ...
      <div className="relative h-64 w-full overflow-hidden">
        ...
        <div className="absolute top-6 left-6">
          <span className="bg-black/60 backdrop-blur-xl text-[9px] font-black px-4 py-2 rounded-xl uppercase tracking-widest border border-white/10 flex items-center gap-2">
        ...
        <div className="absolute bottom-6 left-8">
           <span className="text-4xl font-black text-white tracking-tighter">₹{meal.price}</span>
        </div>
      </div>
      ...
      <div className="p-8">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h3 className="text-[#737373] text-[10px] font-black uppercase tracking-[0.2em] truncate">
            {meal.hotelName}
          </h3>
        </div>
        ...
        <div className="flex items-center justify-between gap-4 border-t border-white/5 pt-8">
          <div className="flex flex-col">
            ...
            <div className={`text-xs font-bold flex items-center gap-2 ${timeLeft === "Expired" ? "text-red-500" : "text-white"}`}>
          ...
          {timeLeft === "Expired" ? (
            ...
            <Link
              href={`/studentMeals/${meal.id}`}
              className="px-8 py-4 bg-white text-black rounded-2xl font-black uppercase text-[10px] tracking-widest hover:bg-orange-500 hover:text-white transition-all shadow-lg active:scale-95"
            >
